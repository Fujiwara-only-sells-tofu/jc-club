...
import com.jcclub.practice.api.enums.AnswerStatusEnum;
...
import com.jcclub.practice.server.entity.dto.SubjectDTO;
import com.jcclub.practice.server.entity.dto.SubjectDetailDTO;
import com.jcclub.practice.server.entity.dto.SubjectOptionDTO;
import com.jcclub.practice.server.entity.dto.UserInfo;
import com.jcclub.practice.server.entity.po.*;
import com.jcclub.practice.server.mapper.*;
import com.jcclub.practice.server.rpc.UserRpc;
import com.jcclub.practice.server.service.IPracticeDetailService;
...
@Slf4j
public class PracticeDetailServiceImpl extends ServiceImpl<PracticeDetailMapper, PracticeDetailPO> implements IPracticeDetailService {


   
    private final PracticeDetailMapper practiceDetailDao;

   
    private final PracticeSetMapper practiceSetDao;

   
    private final PracticeSetDetailMapper practiceSetDetailDao;

   
    private final PracticeMapper practiceDao;

   
    private final SubjectMapper subjectDao;

   
    private final SubjectRadioMapper subjectRadioDao;

   
    private final SubjectMultipleMapper subjectMultipleDao;

   
    private final SubjectJudgeMapper subjectJudgeDao;

   
    private final SubjectMappingMapper subjectMappingDao;

   
    private final SubjectLabelMapper subjectLabelDao;
